...
| 🔐 로그인    | -         | `/seller/login`              | 소셜 로그인 (Google, Kakao) | 비로그인    |
| 📝 가게 등록 | -         | `/seller/register`           | 사업자 + 가게 정보 입력     | 로그인      |
| ⏳ 승인 대기 | -         | `/seller/pending`            | 승인 상태 확인              | 등록 신청자 |
| 📊 대시보드  | -         | `/seller/dashboard`          | 오늘의 주문 현황            | 판매자      |
| 📦 상품 관리 | -         | `/seller/products`           | 상품 목록                   | 판매자      |
|              | 상품 등록 | `/seller/products/new`       | 새 상품 등록                | 판매자      |
|              | 상품 수정 | `/seller/products/[id]/edit` | 상품 정보 수정              | 판매자      |
| 📋 주문 관리 | -         | `/seller/orders`             | 주문 목록                   | 판매자      |
|              | 주문 상세 | `/seller/orders/[id]`        | 주문 상세, 픽업 처리        | 판매자      |
| 🏠 가게 관리 | -         | `/seller/store`              | 가게 정보                   | 판매자      |
|              | 정보 수정 | `/seller/store/edit`         | 가게 정보 수정              | 판매자      |
...
|                | 승인 요청 | `/admin/stores/pending` | 승인 대기 목록       | 관리자 |
|                | 가게 상세 | `/admin/stores/[id]`    | 가게 상세, 승인/거절 | 관리자 |
...
```
[소비자 홈] ──"판매자 등록"──→ [판매자 홈] → [로그인] → [가게 등록] → [승인 대기] → [대시보드]
(서비스 소개)
```
...
```
[대시보드] → [가게 관리] → [승인 요청 목록] → [가게 상세] → [승인/거절]
```
...
/seller/register ............. 가게 등록 신청
/seller/pending .............. 승인 대기
...
/admin ....................... 대시보드
/admin/stores ................ 가게 목록
/admin/stores/pending ........ 승인 요청 목록
/admin/stores/[id] ........... 가게 상세
/admin/users ................. 사용자 목록
...
flowchart TB
  ...
  subgraph SELLER_SIDE["🏪 판매자 영역"]
      ...
      subgraph AUTH_S["🔓 로그인 후"]
          ...
          subgraph S_DASHBOARD["📊 판매자 대시보드 (승인 후)"]
              S_DASH["대시보드 메인"]
